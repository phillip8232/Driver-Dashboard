...
const Navbar = () => Navbar_jsx("div", null, Navbar_jsx(external_semantic_ui_react_["Menu"], {
  fixed: "top",
  inverted: true
}, Navbar_jsx(external_semantic_ui_react_["Container"], null, Navbar_jsx(external_semantic_ui_react_["Menu"].Item, {
  as: "a",
  header: true,
  href: "https://www.gofar.co",
  target: "_blank"
}, Navbar_jsx(external_semantic_ui_react_["Image"], {
  size: "tiny",
  src: GoFarlogo_default.a,
  style: {
    marginRight: "1.5em"
  ...
  as: "a"
}, "Home"), Navbar_jsx(external_semantic_ui_react_["Dropdown"], {
  item: true,
  simple: true,
  text: "More"
}, Navbar_jsx(external_semantic_ui_react_["Dropdown"].Menu, null, Navbar_jsx(external_semantic_ui_react_["Dropdown"].Item, {
  as: "a",
  href: "https://www.gofar.co/about-us/",
  target: "_blank"
}, "About Us"), Navbar_jsx(external_semantic_ui_react_["Dropdown"].Item, null, "Whatever"), Navbar_jsx(external_semantic_ui_react_["Dropdown"].Divider, null), Navbar_jsx(external_semantic_ui_react_["Dropdown"].Header, null, "Header Item"), Navbar_jsx(external_semantic_ui_react_["Dropdown"].Item, null, Navbar_jsx("i", {
  className: "dropdown icon"
}), Navbar_jsx("span", {
  className: "text"
}, "Submenu"), Navbar_jsx(external_semantic_ui_react_["Dropdown"].Menu, null, Navbar_jsx(external_semantic_ui_react_["Dropdown"].Item, null, "List Item"), Navbar_jsx(external_semantic_ui_react_["Dropdown"].Item, null, "List Item"))), Navbar_jsx(external_semantic_ui_react_["Dropdown"].Item, null, "List Item"))))));
...
const LoginView = props => {
  ...
  }, LoginView_jsx(Components_Navbar, null), enteredInvalidPassword && LoginView_jsx("p", null, "Invalid Password"), loading && LoginView_jsx(LoadingSpinner["a" /* default */], null), renderBody(executeLogin)));
};
...
function handleSuccessfulLogin(router) {
  return function (loginResult) {
    external_js_cookie_default.a.set('GofarDashboardUserId', loginResult.userId, {
      expires: 7
    });
    external_js_cookie_default.a.set('GofarDashboardToken', loginResult.authToken, {
      expires: 7
    });
...
function LoginPage(props) {
  if (props.authToken) {
    return login_jsx(external_react_router_dom_["Redirect"], {
      to: "/dashboard"
    });
  }
  ...
  return login_jsx(external_react_apollo_["ApolloProvider"], {
    client: client
  }, login_jsx(Login_LoginView, _extends({}, props, {
