...
function DashboardHeader(props) {
  ...
  if (carLoading) {
    ...
    return DashboardHeader_jsx("div", {
      ...
      as: "h1"
    }, "Welcome back! ", userData.firstName), DashboardHeader_jsx("div", {
...
class DiagnosticCard_DiagnosticCard extends external_react_["Component"] {
  render() {
    return DiagnosticCard_jsx(external_semantic_ui_react_["Card"], {
      ...
      className: "data-content"
    }, DiagnosticCard_jsx("p", null, "Diagnostic Issues"), DiagnosticCard_jsx("h2", null, this.props.diagnosticIssue)), DiagnosticCard_jsx(external_semantic_ui_react_["Card"].Content, {
      extra: true
...
class GoogleMap_SimpleMap extends external_react_["Component"] {
  ...
  // };
  render() {
    return GoogleMap_jsx(external_semantic_ui_react_["Segment"], null, GoogleMap_jsx(external_semantic_ui_react_["Header"], {
      icon: true
...
class AntdTableComponent_AntdTableComponent extends external_react_default.a.Component {
  ...
  render() {
    ...
    return AntdTableComponent_jsx(external_semantic_ui_react_["Segment"], null, AntdTableComponent_jsx("div", null, AntdTableComponent_jsx("div", {
      ...
      columns: columns,
      dataSource: AntdTableComponent_data,
...
function CarData(props) {
  ...
  if (loading) {
    ...
    }, CarData_jsx(external_semantic_ui_react_["Card"].Group, null, CarData_jsx(Card_LastFillUpCard, {
    ...
    }), CarData_jsx(Card_DiagnosticCard // diagnosticIssue={data.car.diagnosticIssue}
    , {
      ...
      className: "ui container"
    }, CarData_jsx(AntdTable_AntdTableComponent, null)));
  }
}
...
function DashboardPage(props) {
  console.log(`THIS IS COMING FROM DASH BOARD PAGE`, external_js_cookie_default.a.get('GofarDashboardToken'));
  debugger; // TODO if not logged in redirect to login

  if (external_js_cookie_default.a.get('GofarDashboardToken') && external_js_cookie_default.a.get('GofarDashboardUserId')) {
    dashboard_jsx(external_react_router_dom_["Redirect"], {
      to: "/dashboard"
    });
  } else {
    dashboard_jsx(external_react_router_dom_["Redirect"], {
  ...
  const client = new external_apollo_boost_default.a({
    ...
    headers: {
      Authorization: external_js_cookie_default.a.get('GofarDashboardToken'),
      UserID: external_js_cookie_default.a.get('GofarDashboardUserId'),
