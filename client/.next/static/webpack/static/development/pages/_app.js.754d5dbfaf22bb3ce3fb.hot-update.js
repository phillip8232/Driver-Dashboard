...
function App() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    return () => {
      ...
      window.localStorage.setItem('GofarDashboardUserId', loginResult.userId);
      const {
        0: localUserId
      } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(localStorage.getItem('GofarDashboardUserId'));
      const {
        0: localToken
      } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(localStorage.getItem('GofarDashboardToken')); // localStorage.getItem('GofarDashboardUserId')
...
//# sourceMappingURL=_app.js.754d5dbfaf22bb3ce3fb.hot-update.js.map