...
function DashboardPage(props) {
  ...
  const client = new apollo_boost__WEBPACK_IMPORTED_MODULE_6__["default"]({
    ...
    headers: {
      Authorization: document.cookie.replace(/(?:(?:^|.*;\s*)GofarDashboardToken\s*\=\s*([^;]*).*$)|^.*$/, "$1"),
      UserID: document.cookie.replace(/(?:(?:^|.*;\s*)GofarDashboardUserId\s*\=\s*([^;]*).*$)|^.*$/, "$1"),
...
//# sourceMappingURL=dashboard.js.b8135f27982463545c2d.hot-update.js.map