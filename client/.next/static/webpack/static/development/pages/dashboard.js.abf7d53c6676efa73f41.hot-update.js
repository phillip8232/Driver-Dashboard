...
function DashboardPage(props) {
  ...
  const cookieToken = document.cookie.replace(/(?:(?:^|.*;\s*)GofarDashboardToken\s*\=\s*([^;]*).*$)|^.*$/, "$1");
  const cookieUser = document.cookie.replace(/(?:(?:^|.*;\s*)GofarDashboardUserId\s*\=\s*([^;]*).*$)|^.*$/, "$1");
...
//# sourceMappingURL=dashboard.js.abf7d53c6676efa73f41.hot-update.js.map