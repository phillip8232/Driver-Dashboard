...
function DashboardPage(props) {
  ...
  const {
    0: user,
    1: setUserID
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(null); // TODO if not logged in redirect to login
...
DashboardPage.getInitialProps = ctx => {
  setAuthrization(next_cookies__WEBPACK_IMPORTED_MODULE_3___default()(ctx).GofarDashboardToken);
  setAuthrization(next_cookies__WEBPACK_IMPORTED_MODULE_3___default()(ctx).GofarDashboardUserId);
  return {
...
//# sourceMappingURL=dashboard.js.27de0848a8d1e3677d6e.hot-update.js.map