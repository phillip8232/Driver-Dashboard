...
function DashboardPage(props) {
  ...
  const client = new apollo_boost__WEBPACK_IMPORTED_MODULE_6__["default"]({
    ...
    headers: {
      Authorization: next_cookies__WEBPACK_IMPORTED_MODULE_3___default()(ctx).GofarDashboardToken,
      UserID: next_cookies__WEBPACK_IMPORTED_MODULE_3___default()(ctx).GofarDashboardUserId,
...
DashboardPage.getInitialProps = ctx => {
  console.log("THIS IS COMING FROM DASHBOARD", next_cookies__WEBPACK_IMPORTED_MODULE_3___default()(ctx).GofarDashboardToken);
  return {
...
//# sourceMappingURL=dashboard.js.f49701d0c8a656426014.hot-update.js.map