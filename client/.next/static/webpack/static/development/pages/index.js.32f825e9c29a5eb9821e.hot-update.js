...
LoginPage.getInitialProps = ctx => {
  return {
    cookiezToken: next_cookies__WEBPACK_IMPORTED_MODULE_3___default()(ctx).GofarDashboardToken || '',
    cookiezUser: next_cookies__WEBPACK_IMPORTED_MODULE_3___default()(ctx).GofarDashboardUserId || ''
  };
  console.log("THIS IS COMING FROM INDEX", cookiezToken);
};

/***/ })

})
//# sourceMappingURL=index.js.32f825e9c29a5eb9821e.hot-update.js.map